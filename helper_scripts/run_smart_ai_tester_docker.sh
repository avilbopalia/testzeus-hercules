...
###############################################################################
# 2) Pull the SmartAITester Docker image
###############################################################################
echo "Pulling the latest smartaitester/smart-ai-tester Docker image..."
...
###############################################################################
echo "Running smartaitester/smart-ai-tester:latest Docker container..."
...
echo "SmartAITester run completed."
