...
from smart_ai_tester.config import get_global_conf, set_global_conf
from smart_ai_tester.core.runner import SingleCommandInputRunner
from smart_ai_tester.telemetry import EventData, EventType, add_event
from smart_ai_tester.utils.gherkin_helper import (
    process_feature_file,
    serialize_feature_file,
)
from smart_ai_tester.utils.junit_helper import JUnitXMLGenerator, build_junit_xml
...
async def sequential_process() -> None:
    ...
    for feat in list_of_feats:
        ...
        if get_global_conf().get_token_verbose():
            ...
            for ag_name, agent in runner.smart_ai_tester_core.agents_map.items():
