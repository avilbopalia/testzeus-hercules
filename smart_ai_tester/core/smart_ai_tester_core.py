...
from smart_ai_tester.utils.model_utils import adapt_llm_params_for_model
...
from smart_ai_tester.core.agents.api_nav_agent import ApiNavAgent
from smart_ai_tester.core.agents.browser_nav_agent import BrowserNavAgent
from smart_ai_tester.core.agents.executor_nav_agent import ExecutorNavAgent
from smart_ai_tester.core.agents.high_level_planner_agent import PlannerAgent
from smart_ai_tester.core.agents.mcp_nav_agent import McpNavAgent
from smart_ai_tester.core.agents.sec_nav_agent import SecNavAgent
from smart_ai_tester.core.agents.sql_nav_agent import SqlNavAgent
from smart_ai_tester.core.agents.time_keeper_nav_agent import TimeKeeperNavAgent
from smart_ai_tester.core.extra_tools import *
from smart_ai_tester.core.memory.dynamic_ltm import DynamicLTM
from smart_ai_tester.core.memory.state_handler import store_run_data
from smart_ai_tester.core.post_process_responses import (
    final_reply_callback_planner_agent as notify_planner_messages,  # type: ignore
)
from smart_ai_tester.core.prompts import LLM_PROMPTS
from smart_ai_tester.core.tools import *
from smart_ai_tester.core.tools.get_url import geturl
from smart_ai_tester.telemetry import EventData, EventType, add_event
from smart_ai_tester.utils.detect_llm_loops import is_agent_stuck_in_loop
from smart_ai_tester.utils.llm_helper import (
...
from smart_ai_tester.utils.logger import logger
from smart_ai_tester.utils.response_parser import parse_response
from smart_ai_tester.utils.sequential_function_call import (
    UserProxyAgent_SequentialFunctionExecution,
)
from smart_ai_tester.utils.timestamp_helper import get_timestamp_str
from smart_ai_tester.utils.ui_messagetype import MessageType
...
class SmartAITester:
    ...
    async def create(
        ...
        """
        Create an instance of SmartAITester.
        ...
        Returns:
            SmartAITester: An instance of SmartAITester.

        """
        logger.info(
            f">>> Creating SmartAITester, Planner max chat rounds: {planner_max_chat_round}, browser nav max chat rounds: {browser_nav_max_chat_round}. Save chat logs to files: {save_chat_logs_to_files}"
        )
    ...
    async def shutdown(self) -> None:
        """Shutdown the SmartAITester instance."""
