...
from smart_ai_tester.config import get_global_conf  # Add this import
from smart_ai_tester.core.browser_logger import get_browser_logger
from smart_ai_tester.core.playwright_manager import PlaywrightManager
from smart_ai_tester.core.tools.dropdown_using_selector import (
    interact_with_element_select_type,
)
from smart_ai_tester.core.tools.press_key_combination import press_key_combination
from smart_ai_tester.core.tools.tool_registry import tool
from smart_ai_tester.telemetry import EventData, EventType, add_event
from smart_ai_tester.utils.dom_helper import get_element_outer_html
from smart_ai_tester.utils.dom_mutation_observer import subscribe, unsubscribe
from smart_ai_tester.utils.js_helper import block_ads, get_js_with_element_finder
